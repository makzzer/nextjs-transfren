        ...
        <div className="bg-white shadow-lg rounded-lg p-8 md:p-16">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="flex flex-col items-center text-center">
              <Image src="/images/father.jpg" alt="Padre" width={160} height={160} className="rounded-full"/>
              <h3 className="mt-6 text-2xl font-bold text-gray-900">Juan Pérez</h3>
            ...
            <div className="flex flex-col items-center text-center">
              <Image src="/images/son.jpg" alt="Hijo" width={160} height={160} className="rounded-full"/>
              <h3 className="mt-6 text-2xl font-bold text-gray-900">Carlos Pérez</h3>
